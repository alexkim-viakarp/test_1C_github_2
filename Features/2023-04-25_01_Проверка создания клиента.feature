...
Как Опереатор я хочу
	создать клиента
чтобы вести в клиентскую базу
...
* Заполнение номера телефона клиента
	//Когда открылось окно 'Контрагент (создание) *'
	И в поле с именем 'Страна' я ввожу текст 'Казахстан'
	И в поле с именем 'Телефон' я ввожу текст '+7 777 701-01-23'
	//
* Сохранние
